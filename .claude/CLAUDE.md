...
Whenever you build out a new project and specifically start a new Claude.md. This is important
...
- YOU MUST review the comment if you decided to add it, if you didn't overengineer the code so it has to have comment. If you overengineered, refine, if you don't, you MUST tell me about it and let me decide.
...
1. MUST not add coauthored information.

2. Commit messages MUST focus on why we did those changes and what indstead of how. 

3. Mandatory Pre-Commit Failure Protocol
...
4. Explicit Git Flag Prohibition
...
7. Learning-Focused Error Response
